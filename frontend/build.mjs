...
await mkdir('dist',{recursive:true});await copyFile('index.html','dist/index.html');await copyFile('_headers','dist/_headers');await copyFile('../toastDexLogo.png','dist/toastDexLogo.png');
